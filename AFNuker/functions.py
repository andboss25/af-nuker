...
def say_command(BOT,text_arg):
        try:
            ...
            try:
                ...
                print(Fore.GREEN + "Said " + Fore.BLUE + content + Fore.GREEN + " in channel " + Fore.BLUE + channel.GetChannelName() + Fore.WHITE)
            except:
...
def list_command(BOT):
        ...
        for i in BOT.GetBotGuilds():
            print(Fore.LIGHTBLACK_EX + i.GetGuildName() + " - id is " + i.guildid + Fore.WHITE)
            n = n + 1
...
def nuke_command(BOT,text_arg,values):
        try:
            ...
            YN=input("Are you sure you wanna nuke " + Fore.BLUE + guild.GetGuildName() + Fore.WHITE + "? " + Fore.GREEN + "y" + Fore.WHITE + "/" + Fore.RED + "n " + Fore.WHITE)
            if YN.capitalize() == "N":
                print(Fore.RED + "Aborted nuke" + Fore.WHITE)
            elif YN.capitalize() == "Y":
                print("Nuking " + Fore.BLUE + guild.GetGuildName() + Fore.WHITE)
                try:
                    ...
                    if text_arg[2].endswith(".afnk"):
                        ...
                        if errors == 0:
                            ...
                            if values["guild-rename"]["enabled"]:
                                ...
                                response = guild.ChangeGuildName(values["guild-rename"]["name"])
                                try:
                                    e = response["name"]
                                    print(Fore.GREEN + "Renamed guild to " + Fore.BLUE + guild.GetGuildName() + Fore.WHITE)
                                except:
                            ...
                            if values["channel-rename"]["enabled"]:
                                ...
                                for i in guild.GetGuildChannels():
                                    old_name = i.GetChannelName()
                                    response = i.ChangeGuildChannelName(channel_rename_name)
                                    try:
                                        e = response["name"]
                                        print(Fore.GREEN + "Renamed channel " + Fore.BLUE + old_name + Fore.WHITE)
                                    except:
                                        print(Fore.RED + "Cloudn't rename channel " + i.GetChannelName() + Fore.WHITE)
                                ...
                                for user in guild.GetGuildMembers(limit=1000):
                                    if values["ban-nuke"]["delete-messages"]:
                                        ...
                                        try:
                                            ...
                                            print(Fore.RED + "Cloudn't ban " + Fore.BLUE + user.GetUserName() + Fore.WHITE)
                                        except:
                                            print(Fore.GREEN + "Bannned " + Fore.BLUE + user.GetUserName() + Fore.WHITE)
                                    else:
                                        try:
                            ...
                            def channel_nuke():
                                if values["channel-nuke"]["enabled"]:
                                    ...
                                    while True:
                                        ...
                                        if channel.IsChannelErrorfull():
                                            print(Fore.RED + "Cloudn't make channnel" + Fore.WHITE)
                                        else:
        ...
        try:
            ...
            for member in guild.GetGuildMembers(1000):
                ...
                if member_count == 1000:
                    member_count = "1000+"
            print(Fore.BLUE + guild.GetGuildName() + Fore.LIGHTBLACK_EX + " has " + Fore.BLUE + str(member_count) + Fore.LIGHTBLACK_EX + " members!" + Fore.WHITE)
        except:
...
def invite_command(BOT,text_arg):
    try:
        ...
        print(Fore.GREEN + "Generated invite code for " + Fore.BLUE + guild.GetGuildName() + Fore.WHITE + " : " + Fore.BLUE + invite + Fore.WHITE)
    except:
        print(Fore.RED + "Invalid use of command membercount , please use: " + Fore.WHITE)
